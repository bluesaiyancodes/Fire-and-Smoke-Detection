...
from PyQt5.QtWidgets import (QApplication, QMainWindow, QLabel, QPushButton, 
                             ...
                             QCheckBox, QHBoxLayout, QGridLayout, QFrame)
...
class FireSmokeDetectionApp(QMainWindow):
    ...
    def initUI(self):
        ...
        self.input_image_label.setFixedSize(570, 450)  # Adjusted image label size
        self.output_image_label.setFixedSize(570, 450)  # Adjusted image label size
        ...
        main_layout.addWidget(divider, 0, 1)
        main_layout.addLayout(controls_layout, 0, 2)
        main_layout.addLayout(button_layout, 1, 0, 1, 3, alignment=Qt.AlignCenter)
